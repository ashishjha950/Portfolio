...
function  About() {
  return (
    <div id='aboutus' className='h-full w-full mt-20 md:mt-6 lg:mt-2 text-white ' >
      ...
      <h1 className='w-full md:w-4/5 lg:w-3/5 xl:w-1/2 my-10 m-auto text-sm sm:text-base text-center'>I’m a MERN Stack Developer with strong expertise in Node.js, Express.js, MongoDB, React.js, JavaScript, Tailwind CSS, HTML and CSS. I have practical experience with state management tools like Redux Toolkit and Zustand, navigation libraries like React Router DOM, and real-time communication using Socket.io. <br />Additionally, I’m proficient with development tools such as NPM, Git, GitHub, Postman, and deployment platforms like Vercel, Render, and MongoDB Atlas.<br /> <br /> I’m specialize in building responsive, user-friendly, and scalable web applications, always eager to learn, adapt, and tackle new challenges in web development.</h1>
      {/* Services */}
